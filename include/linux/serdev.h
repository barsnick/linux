...
static inline int serdev_device_get_data_bits(struct serdev_device *)
{
	return -ENODEV;
}
static inline int serdev_device_get_parity(struct serdev_device *)
{
	return -ENODEV;
}
static inline int serdev_device_get_stop_bits(struct serdev_device *)
{
	return -ENODEV;
}
